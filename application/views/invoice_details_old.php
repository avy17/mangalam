...
<div id="full-page">
                                        ...
                                        <div>
                                            <table  id="simple-table" class="table table-striped table-bordered table-hover">
                                                <caption class="right">Original for buyer</caption>
                                                <thead>
                                                    <tr>
                                                        <th></th>
                    ...
                    ?>
                                                    <tr>
                                                        ...
                                                        <td style="padding-left:2px;"><?php echo $em['qty']?></td>
                    ...
                    ?>
                                                    <tr>
                                                        ...
                                                        <td class="middle"><?php echo  number_format((((($em['rate'])*$em['gst'])/100)/2),2);  ?> </td>
                                                       <td class="middle">@<?php echo  ($em['gst']/2);  ?>%</td>
