							...
							<div class="col-xs-12">
								...
								<?php echo form_open_multipart('',array('class' => 'form-horizontal form-label-left')); ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" value="<?php echo $last_invoice;?>" name="invoice_no" id="invoice_no" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input class="date-picker col-xs-10 col-sm-5" id="id-date-picker-1" readonly="true" type="text" name="date" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y')?>" />
										</div>
									</div>
