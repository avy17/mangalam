							...
							<div class="col-xs-12">
 								...
 								<?php echo form_open_multipart('',array('class' => 'form-horizontal form-label-left')); ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" value="<?php echo $resultArr['email']?>" name="email" id="form-field-1" placeholder="Optional" class="col-xs-10 col-sm-5" />
										</div>
									</div>
										...
										<div class="col-sm-9">
											<input type="text" value="<?php echo $resultArr['address']?>" name="address" id="form-field-1" placeholder="Mandatory" class="col-xs-10 col-sm-5" />
										</div>
									</div>
										...
										<div class="col-sm-9">
											<input type="number" value="<?php echo $resultArr['pincode']?>" name="pincode" id="form-field-1" placeholder="Mandatory" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="city" id="form-field-1" placeholder="" value="<?php echo $resultArr['city']?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" value="<?php echo $resultArr['contact']?>" name="contact" id="form-field-1" placeholder="Optional" class="col-xs-10 col-sm-5" />
										</div>
									</div>
										...
										<div class="col-sm-9">
											<input type="text" value="<?php echo $resultArr['pan']?>" name="pan" id="form-field-1" placeholder="Mandatory" value="Lucknow" class="col-xs-10 col-sm-5" />
										</div>
									</div>
										...
										<div class="col-sm-9">
											<input type="text" value="<?php echo $resultArr['gst_no']?>" name="gst_no" id="form-field-1" placeholder="Optional" value="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
